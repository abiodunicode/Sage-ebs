      ...
      >
        ...
        <ul class="nav navbar-nav navbar-right">
          ...
          @if(!auth()->guard('customer')->check())
           ...
           <li class="dropdown">
              <a href="#" class="dropdown-toggle avatar" data-toggle="dropdown">{{ Auth::guard('customer')->user()->name }}<span class="badge">*</span></a>
            ...
            <li class="m_2"><a href="{ route('customer.logout') }}" onclick="event.preventDefault();
