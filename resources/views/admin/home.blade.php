...
<div class="card-body">
	  ...
	  <div class="span_11">
		<div class="col-md-6 col_4">
			...
			<link rel="stylesheet" href="{{asset('ebs')}}/css/clndr.css" type="text/css" />
			<script src="{asset('ebs')}}js/underscore-min.js" type="text/javascript"></script>
			<script src= "{asset('ebs')}}js/moment-2.2.1.js" type="text/javascript"></script>
			<script src="j{asset('ebs')}}s/clndr.js" type="text/javascript"></script>
			<script src="j{asset('ebs')}}s/site.js" type="text/javascript"></script>
