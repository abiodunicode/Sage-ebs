...
<div class="card-body">
	   ...
	   <div class="xs">
  	    <h3>Edit Ship Schedule</h3>
  	    <div class="well1 white ">
        
        <div class="row">
        <div class="col-md-8 col-lg-8 ">
        <form  method="post" class="form-horizontal" action="{{route('shipschedule.update',[$shipschedule->id])}}">
        {{ method_field('PATCH') }}
        {{csrf_field()}}
        ...
        <div class="form-group">
                    ...
                    required
                    spellcheck="false" 
                    value="{{$shipschedule->vessel_name}}"
                ...
                <div class="form-group">
                    ...
                    name="vessel_voyage"
                    spellcheck="false"
                    value="{{$shipschedule->vessel_voyage}}"
                ...
                <div class="form-group">
                    ...
                    name="vessel_line"
                    spellcheck="false" 
                    value="{{$shipschedule->vessel_line}}"
                ...
                <div class="form-group">
                    ...
                    name="vessel_status"
                    spellcheck="false"
                    value="{{$shipschedule->vessel_status}}"
              	...
              	<div class="form-group">
                    ...
                    name="vessel_port"
                    spellcheck="false"
                    value="{{$shipschedule->vessel_port}}"
                ...
                <div class="form-group">
                    ...
                    spellcheck="false"
                    class="form-control1" 
                    value="{{$shipschedule->vessel_terminal}}"
                ...
                <div class="form-group">
                  ...
                  id="vessel_arrival_date"
                    ...
                    value="{{$shipschedule->vessel_arrival_date}}"
                  required="">
									</div>
                ...
                <div class="form-group">
                    ...
                    value="{{$shipschedule->vessel_berthing_time}}"
                    placeholder="">
									</div>
                ...
                <div class="form-group">
                    ...
                    value="{{$shipschedule->vessel_departure_time}}"
                    id="focusedinput" 
                    placeholder="">
									</div>
